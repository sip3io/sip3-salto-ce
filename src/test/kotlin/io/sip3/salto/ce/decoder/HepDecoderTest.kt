...
class HepDecoderTest : VertxTest() {
    ...
    companion object {
        ...
        val PACKET_3 = byteArrayOf(
                0x48.toByte(), 0x45.toByte(), 0x50.toByte(), 0x33.toByte(),
                0x02.toByte(), 0xb7.toByte(), 0x00.toByte(), 0x00.toByte(), 0x00.toByte(), 0x01.toByte(), 0x00.toByte(), 0x07.toByte(), 0x02.toByte(), 0x00.toByte(), 0x00.toByte(), 0x00.toByte(), 0x02.toByte(), 0x00.toByte(), 0x07.toByte(), 0x11.toByte(),
                0x00.toByte(), 0x00.toByte(), 0x00.toByte(), 0x03.toByte(), 0x00.toByte(), 0x0a.toByte(), 0xc0.toByte(), 0xa8.toByte(), 0x09.toByte(), 0x77.toByte(), 0x00.toByte(), 0x00.toByte(), 0x00.toByte(), 0x04.toByte(), 0x00.toByte(), 0x0a.toByte(),
                0xc0.toByte(), 0xa8.toByte(), 0x04.toByte(), 0x8c.toByte(), 0x00.toByte(), 0x00.toByte(), 0x00.toByte(), 0x07.toByte(), 0x00.toByte(), 0x08.toByte(), 0x46.toByte(), 0x31.toByte(), 0x00.toByte(), 0x00.toByte(), 0x00.toByte(), 0x08.toByte(),
                0x00.toByte(), 0x08.toByte(), 0x13.toByte(), 0x8d.toByte(), 0x00.toByte(), 0x00.toByte(), 0x00.toByte(), 0x09.toByte(), 0x00.toByte(), 0x0a.toByte(), 0x5f.toByte(), 0x86.toByte(), 0x9c.toByte(), 0xc8.toByte(), 0x00.toByte(), 0x00.toByte(),
                0x00.toByte(), 0x0a.toByte(), 0x00.toByte(), 0x0a.toByte(), 0x00.toByte(), 0x01.toByte(), 0x03.toByte(), 0x1e.toByte(), 0x00.toByte(), 0x00.toByte(), 0x00.toByte(), 0x0b.toByte(), 0x00.toByte(), 0x07.toByte(), 0x05.toByte(), 0x00.toByte(),
                0x00.toByte(), 0x00.toByte(), 0x0c.toByte(), 0x00.toByte(), 0x0a.toByte(), 0x00.toByte(), 0x00.toByte(), 0x07.toByte(), 0xd2.toByte(), 0x00.toByte(), 0x00.toByte(), 0x00.toByte(), 0x0f.toByte(), 0x02.toByte(), 0x28.toByte(), 0x7b.toByte(),
                0x22.toByte(), 0x73.toByte(), 0x65.toByte(), 0x6e.toByte(), 0x64.toByte(), 0x65.toByte(), 0x72.toByte(), 0x5f.toByte(), 0x69.toByte(), 0x6e.toByte(), 0x66.toByte(), 0x6f.toByte(), 0x72.toByte(), 0x6d.toByte(), 0x61.toByte(), 0x74.toByte(),
                ...
                0x7d.toByte(), 0x00.toByte(), 0x00.toByte(), 0x00.toByte(), 0x11.toByte(), 0x00.toByte(), 0x2a.toByte(), 0x39.toByte(), 0x34.toByte(), 0x36.toByte(), 0x62.toByte(), 0x35.toByte(), 0x62.toByte(), 0x33.toByte(), 0x63.toByte(), 0x2d.toByte(),
    ...
    fun `Decode HEPv3 RTCP packet`() {
        runTest(
                ...
                execute = {
                    ...
                    vertx.eventBus().localRequest<Any>(RoutesCE.hep3, Pair(sender, Buffer.buffer(PACKET_3)))
                },
                assert = {
                    vertx.eventBus().consumer<Pair<Address, Packet>>(RoutesCE.router) { event ->
                        val (_, packet) = event.body()
...
//                            assertEquals(43269, src.port)
                            val dst = packet.dstAddr
                            assertEquals("192.168.4.140", dst.addr)
//                            assertEquals(15060, dst.port)
                        }
                        context.completeNow()
                    }
                }
