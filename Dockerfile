...
ENTRYPOINT java $JAVA_OPTS -jar $EXECUTABLE_FILE --options=$VERTX_OPTIONS_FILE -Dconfig.location=$CONFIG_FILE -Dcodecs.location=$CODECS_FILE -Dudf.location=$UDF_FOLDER -Dlogback.configurationFile=$LOGBACK_FILE